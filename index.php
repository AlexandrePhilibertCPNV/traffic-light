...
if (isset($_GET['next'])) {
    ...
    $_SESSION['last_state'] = $traffic_light->set_next_state(4);
} else {
    // Set the default state
    $_SESSION['last_state'] = $traffic_light->set_next_state(0);
}
...
<body>
    <div class="traffic-light">
        ...
        <div class="bulb <?= $traffic_light->yellow ? 'bulb-yellow' : '' ?> <?= $traffic_light->state == 4 ? 'bulb-blinking' : '' ?>"></div>
